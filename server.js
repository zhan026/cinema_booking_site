...
db.serialize(() => {
  ...
  const movies = [
    [1, "Дюна 2", "dune2.jpg", "сегодня", "13:00,16:00,19:00"],
    [2, "Оппенгеймер", "oppenheimer.jpg", "сегодня", "12:00,15:30,19:15"],
    [3, "Барби", "barbie.jpg", "завтра", "11:00,14:00,18:00"],
    [4, "Миссия невыполнима", "mission.jpg", "послезавтра", "10:00,13:00,17:30"],
    [5, "Побег из Шоушенка", "shawshank.jpg", "завтра", "09:00,12:30,16:00"]
  ];
